...
-- Create roles
SELECT public.map_role_and_permissions('role_with_admin_permission', ARRAY['appointment:read', 'appointment:admin']);
...
SELECT results_eq(
               ...
               $$VALUES (5::bigint)$$,
               'confirm that admin can read all five appointments'
       );
